...
# def findAvailableTimes(nowDay, nowHour, nowMinute, workStart, workEnd, events, timeEst):
...
#         compareEvents(e1, e2, workStart, workEnd, nowDay, nowHour, nowMinute, timeEst)
#
#     lastEvent = events[len(events) - 1]
#     secondToLast = events[len(events) - 2]
#     compareLastEvent(lastEvent, secondToLast, workStart, workEnd, nowDay, nowHour, nowMinute, timeEst)
#
#     # print(availableTimes)
#     return availableTimes
#
#
# def compareLastEvent(lastEvent, secondToLast, workStart, workEnd, nowDay, nowHour, nowMinute, timeEst):
...
#
#
# def compareEvents(e1, e2, workStart, workEnd, nowDay, nowHour, nowMinute, timeEst):
